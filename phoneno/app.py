...
class Location_Tracker:
    def __init__(self, App):
        ...
        self.window.configure(bg="#fb3f90")
        self.window.resizable(False, False)

        #___________Application menu_____________
        Label(App, text="Enter a phone number",fg="white", font=("Times", 20), bg="#fb3f90").place(x=150,y= 30)
        ...
        self.country_label = Label(App,fg="white", font=("Times", 20), bg="#fb3f90")
